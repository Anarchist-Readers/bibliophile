...
const User = () => {
    ...
    const [avatar, setAvatar] = useState('/images/avatar4.png')
    ...
    return (
		...
		<div className="p-4 md:p-12 text-center">
			...
			<div className="mx-auto w-4/5 pt-3 border-b-2 border-indigo-500 opacity-25"></div>
        </div>
        <div className="p-2">
			<p className="p-4 text-base font-bold flex items-center justify-start"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 fill-current text-indigo-700 pr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 4v12l-4-2-4 2V4M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
			...
			<div className="pt-8 pb-8 text-center">
				<button className="bg-indigo-700 hover:bg-indigo-900 text-white font-bold py-2 px-4 rounded-full">
				  Edit
				</button> 
			</div>
		</div>
