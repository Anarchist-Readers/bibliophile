...
const Book = ({book}) => {
    ...
    <div className="w-96 m-auto ">
      <div className=" grid grid-cols-3 grid-rows-7 grid-flow-row overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
        <div className="col-span-1 row-span-6 cardComponent">
        ...
        <div className="col-span-2 row-span-1">
            ...
            <div className={`p-1 flex rounded-md  cardComponent ${ratingColor}`}>
              <svg
        ...
        <div className="col-span-2 row-span-1 cardComponent">
          <header className="flex items-center justify-between leading-tight p-2 md:p-4">
            <h1 className="text-lg">
              <Link className="no-underline hover:underline text-black cardComponent" to={`/books/${book.id}`}>
                {book.title}
              </Link>
            </h1>
          </header>
        ...
        <div className="col-span-2 row-span-1 cardComponent">
            <div className="p-2 flex flex-col text-right">
              <p className="text-sm text-bookGreen">Realease date:</p>
          ...
          <ul className="flex flex-row pl-2 text-gray-600">
              <li className="py-1">
                <div className="transition duration-300 ease-in-out rounded-2xl mr-1 px-2 py-1 hover:bg-blue-200 text-gray-500 hover:text-gray-800">
                  <Link class="text-bookRed" to={`/search?genre=${book.genre}`}>
                    #{book.genre}
                  </Link>
                </div>
              </li>
